...
//             if ($data['status'] == 2) {
//                 $subscription_reference = $this->reference;
//                 //$subscription_referenced = $this->referenced;

// // ibrahim                $payment_reference = $subscription_reference->nextPayment();
//                 //$payment_referenced = $subscription_referenced->nextPayment();

// // ibrahim                $reference_discount = 85.00;

//                 // $reference_discount = setting('reference.price', 10);
//                 // if (!is_numeric($reference_discount)) {
//                 //     $reference_discount = 10;
//                 // }

//                 //$service_price = $this->subscription->getValue('service_price', $subscription->price);
// /* ibrahim
//                 $reference_price = $reference_discount;
//                 if($payment_reference->price <=  $reference_discount)
//                     $reference_price = $payment_reference->price;
// */
//                 //  $referenced_price = $payment_referenced->price -  $reference_discount;
//                 // if($referenced_price <= 0)
//                 //     $referenced_price = $payment_referenced->price;
// /* ibrahim
//                 PaymentPriceEdit::create([
//                     'payment_id' => $payment_reference->id,
//                     'staff_id' => $data['staff_id'],
//                     'old_price' => $payment_reference->price,
//                     'new_price' => $reference_price,
//                     'description' => trans('response.system.referenced', ['price' => $reference_price])
//                 ]);
// */
//                 // PaymentPriceEdit::create([
//                 //     'payment_id' => $payment_referenced->id,
//                 //     'staff_id' => $data['staff_id'],
//                 //     'old_price' => $payment_referenced->price,
//                 //     'new_price' => $referenced_price,
//                 //     'description' => trans('response.system.referenced', ['price' => $referenced_price])
//                 // ]);

// // ibrahim                $payment_reference->price = $reference_price;
// // ibrahim                $payment_reference->save();

//                 // $payment_referenced->price = $referenced_price;
//                 // $payment_referenced->save();
