...
trait SubscriptionPaymentGenerator
{
    ...
    public function setup_payment($value)
    {
        ...
        else if($this->service_id==115 || $this->service_id==117 || $this->service_id==113 || $this->service_id==118 || $this->service_id==110 || 
        $this->service_id==125 || $this->service_id==126 || $this->service_id==127 || $this->service_id==128  || $this->service_id == 165){
        ...
        || $this->service_id==139 || $this->service_id==135 || $this->service_id==136){
          ...
          else if($this->service_id==157 || $this->service_id == 159 || $this->service_id == 178 ){
            // İLK 2 AYA YANSIT 175*2
            $modem_type = (int)$this->getOption('modem');
            if($modem_type == 0 || $modem_type == 1 || $modem_type == 4 || $modem_type == 7){
                $payment = 400;
...
// RuzgarFİBER SMART = 115
    //Yeni tarife eklendiğinde altta değişiklik yap. (İlk 1. aya yansıt)
        if($value == 2){
            ...
            if($this->service_id==81 || $this->service_id==96){
             ...
             if($this->service_id==147 || $this->service_id==146){
                ...
                $payment = 600;
             }if($this->service_id==148 || $this->service_id==149 || $this->service_id == 153 || $this->service_id == 163 || $this->service_id == 165 || $this->service_id == 166 || $this->service_id == 170){
                $payment = 1000;
             }
        ...
        if($value == 4){
            ...
            if($this->service_id==152  || $this->service_id == 166)
            {
                $payment = 100;
            }
