...
class ReferenceController extends Controller
{
    ...
    public function index()
    {
        return view('admin.reference.list', [
           ...
           // 'references' => Reference::where('created_at', '>=', Carbon::now()->subDays(30))->orderBy('status', 'ASC')->orderBy('created_at', 'DESC')->get(),
           // 'references21' => Reference::whereYear('created_at', Carbon::now()->year)->whereMonth('created_at', Carbon::now()->month)->orderBy('status', 'ASC')->orderBy('created_at', 'DESC')->get(),
           // 'references51' => Reference::where('created_at', '>=', Carbon::now()->subDays(365))->orderBy('created_at', 'DESC')->get(),
