...
class CommitControlController extends Controller
// class OtherSalesController extends Controller
{
    ...
    {
        return view('admin.commitcontrol.list', [
            'otherexpenses' => CommitControl::orderBy('id', 'desc')->get()
        ]);
    }
    ...
    {
        return view('admin.commitcontrol.add',[
...
public function store(Request $request)
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(CommitControl $commitcontrol)
    {
        return view('admin.commitcontrol.edit', [
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, CommitControl $commitcontrol)
    {
        $validated = $request->validate($this->rules());
        $validated["subscription_id"] = $request["subscription_id"];

        if ($commitcontrol->update($validated)) {
