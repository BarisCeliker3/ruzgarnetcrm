...
class ContractEndingNoteControler extends Controller
{
    /**
     ...
     */
    public function index(ContractEnding $contractending)
    {
       ...
       return view('admin.contract-notes.list',[
            'contractending' => $contractending,
            'contractNotes' => ContractNote::where('customer_id',$contractending->id)->
  ...
  */
     ...
     * @return \Illuminate\Http\Response
     */
    public function create(ContractEnding $contractending)
    {
        return view('admin.contract-notes.add', [
            'contractending' => $contractending
        ]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(ContractEnding $contractending , Request $request)
    {
        $validated = $request->validate($this->rules());
        $validated["staff_id"] = $request->user()->staff_id;
        $validated["customer_id"] = $contractending->id;

        if ($message = ContractNote::create($validated)) {
            ...
            return response()->json([
                ...
                'redirect' => relative_route('admin.contractending.notes',$contractending->id)
            ]);
        }
