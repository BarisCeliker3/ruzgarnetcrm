...
class InfrastructureController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        if ($json_results->results->adsl->statu) {
            $port_statu = true;
            $json_results->results->adsl->max_speed = floor($json_results->results->adsl->max_speed);
        ...
        if ($json_results->results->vdsl->statu) {
            $port_statu = true;
            $json_results->results->vdsl->max_speed = floor($json_results->results->vdsl->max_speed);
        ...
        if ($port_statu) {
            ...
            $sms->submit('RUZGARNET',$message_sms->message,[$telephone]);
            // SentMessage::create(
            //     [
            //         'full_name' => $full_name,
            //         'phone' => $telephone,
