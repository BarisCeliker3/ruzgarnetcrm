...
class paymentPenalty1 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ruzgarnet:paymentPenalty1';
    ...
    try{
        foreach ($payments as $payment) {
            ...
            PaymentPriceEdit::create([
                ...
                'new_price' => $new_price,
                'description' => trans('response.system.penalty', ['price' => 250])
            ]);
