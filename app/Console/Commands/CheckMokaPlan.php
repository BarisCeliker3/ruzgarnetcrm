...
class CheckMokaPlan extends Command
{
    ...
    public function handle()
    {
        try {
                ...
                if ($payment_plan->Data != null) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            Telegram::send(
                                'Test',
                                'Command - Check Auto Payment : refund çalıştı '
                            );
                        }
                        ...
                        Telegram::send(
                            'Test',
                            'Command - Check Auto Payment : elseif 96 çalıştı '
                        );
                    } else {
                        ...
                        Telegram::send(
                            'Test',
                            'Command - Check Auto Payment : elseif 107 çalıştı'
                        );
                    }
                } else {
                    $plan->status = 4;
            ...
            Telegram::send(
                'Test',
                'Command - Check Auto Payment : try çalıştı '
            );
