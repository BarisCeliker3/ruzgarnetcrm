...
class NotPaid20_10 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ruzgarnet:NotPaid20_10';
    ...
    public function handle()
    {
        try {
            ...
            Telegram::send('Test', 'SendNotPaid20_10 Command - başarılı');
        } catch (Exception $e) {
            Telegram::send('Test', 'SendNotPaid20_10 Command - ' . $e->getMessage());
        }
