...
class NotPaid18 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ruzgarnet:NotPaid18';
    ...
    public function handle()
    {
        try {
            ...
            Telegram::send('Test', 'SendNotPaid18 Command - Mesaj sayısı ' . $i);
        } catch (Exception $e) {
            Telegram::send('Test', 'SendNotPaid18 Command - ' . $e->getMessage());
        }
