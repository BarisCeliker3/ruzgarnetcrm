...
return [
    ...
    "setup_payments" => [
        0 => "Yok",
        1 => "KREDİ KARTINA TAKSİT",
        2 => "İlk aya yansıt",
        3 => "İlk iki aya yansıt",
        4 => "İlk aya yansıt ( CHURN )"
  ...
  //      4 => "İlk üç aya yansıt"
    ...
    // Setup
    'setupiki' => 'Kurulumiki',
    "setup_paymentiki" => 'Kurulum/Aktivasyon Ücreti Ödeme Şekli',
    "setup_paymentikis" => [
        0 => "Yok",
        1 => "Peşin",
        2 => "İlk aya yansıt",
  ...
  //      4 => "İlk üç aya yansıt"
    ...
    'speed_info' => "Paketin Maksimum Hızı",
    // Payment
