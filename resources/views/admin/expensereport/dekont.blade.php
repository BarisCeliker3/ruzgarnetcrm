...
@section('title', meta_title('Dekont Evrakları'))
...
@section('content')
    ...
    <!-- START HAZIRLIK -->
            <div class="card list">
                <div class="card-header">
                    ...
                    <span class="gider-bsl" style="color:#cd2828;"> Dekont Evrakları </span></h4>
                </div>
     ...
     <div class="card-body">
                    <div class="table-responsive">
                         <table class="table table-striped" id="dataTable">
                            <thead style="font-size:15px;background:#cd2828;">
								<tr>
                                    <th style="color:#fff;" scope="col">#</th>
                                    <th style="color:#fff;" scope="col">Fatura</th>
                                    <th style="color:#fff;" scope="col">Fiyat</th>
                                    <th style="color:#fff;" scope="col">Not</th>
                                    <th style="color:#fff;" scope="col">Personel</th>
                            ...
                            <tbody>
                               ...
                               @foreach($expens as $expen)
                                    <tr>
                                        ...
                                        <td>@if($expen->image)
                                            <span class="btn btn-outline-secondary badge-pill"> 
                                               <a href="/dekont/{{$expen->image}}" target="_blank">
                                                 <i class="fas fa-list-alt text-danger" aria-hidden="true" title="Dekont" style="font-size:35px;"></i>
                                               </a>
                                             </span>
                                             @else
                                        ...
                                        <td>
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" data-html="true"  data-placement="right" title="{{ $expen->note }}">
    ...
    foreach($dekontRapor as $mutfakRapo){
      ...
      <div class="gider-tablosu col-12">
        <div id="ocak" class=" gider-tablo tabcontent">
            <h1 class="text-dark"> <span  class="text-dark">2023 Yılı <span style="color:#ad0000">Dekont</span> Gider Raporu</span></h1>
            ...
            $("#dataTable").dataTable({
                ...
                initComplete: function () {
                    this.api().columns().every( function () {
                        ...
                        {
                            var select = $('<select class="form-control text-white" style="background:#ad0000; width:100px;"><option value="">TÜMÜ</option></select>')
