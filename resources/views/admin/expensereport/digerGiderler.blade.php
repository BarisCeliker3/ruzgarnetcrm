...
@section('title', meta_title('Diğer Gider Evrakları'))
...
@section('content')
    ...
    <!-- START HAZIRLIK -->
            <div class="card list">
                <div class="card-header">
                    ...
                    <span style="color:#2b9690;">Diğer Gider Evrakları </span></h4>
                </div>
     ...
     <div class="card-body">
                    <div class="table-responsive">
                         <table class="table table-striped" id="dataTable">
                            <thead style="font-size:15px;background:#2b9690;">
								<tr>
                                        ...
                                        <td>@if($expen->image)
                                            <span class="btn btn-outline-secondary badge-pill"> 
                                               <a href="/dekont/{{$expen->image}}" target="_blank">
                                                 <i class="fa fa-turkish-lira text-danger" aria-hidden="true" title="Diğer Gider" style="font-size:35px;"></i>
                                               </a>
                                             </span>
                                             @else
    ...
    foreach($digerGiderRapor as $mutfakRapo){
      ...
      <div class="gider-tablosu col-12">
        <div id="ocak" class="gider-tablo tabcontent">
            <h1 class="text-dark"> <span  class="text-dark">2023 Yılı <span style="color:#29908a;">Diğer Giderler</span> Gider Raporu</span></h1>
            ...
            $("#dataTable").dataTable({
                ...
                initComplete: function () {
                    this.api().columns().every( function () {
                        ...
                        {
                            var select = $('<select class="form-control text-white " style="background:#16504d;width:100px;"><option value="">TÜMÜ</option></select>')
