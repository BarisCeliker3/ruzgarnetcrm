...
@section('title', meta_title('Günlük Kasa Evrakları'))
...
@section('content')
    ...
    <!-- START HAZIRLIK -->
            <div class="card list">
                <div class="card-header">
                    ...
                    <span style="color:#874dc6;">Günlük Kasa Evrakları </span></h4>
                </div>
     ...
     <div class="card-body">
                    <div class="table-responsive">
                         <table class="table table-striped" id="dataTable">
                            <thead style="font-size:15px;background:#874dc6;">
								<tr>
                                        ...
                                        <td>@if($expen->image)
                                            <span class="btn btn-outline-secondary badge-pill"> 
                                               <a href="/dekont/{{$expen->image}}" target="_blank">
                                                 <i class="fa fa-cash-register text-danger" aria-hidden="true" title="Kasa" style="font-size:35px;"></i>
                                               </a>
                                             </span>
                                             @else
    ...
    foreach($kasaRapor as $mutfakRapo){
      ...
      <div class="gider-tablosu col-12">
        <div id="ocak" class="gider-tablo tabcontent">
            <h1 class="text-dark"> <span  class="text-dark">2023 Yılı <span style="color:#824abe;">Günlük Kasa</span> Gider Raporu</span></h1>
            ...
            $("#dataTable").dataTable({
                ...
                initComplete: function () {
                    this.api().columns().every( function () {
                        ...
                        {
                            var select = $('<select class="form-control text-white" style="background:#422066;width:100px;"><option value="">TÜMÜ</option></select>')
