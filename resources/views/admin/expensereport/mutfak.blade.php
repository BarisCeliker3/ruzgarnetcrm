...
@section('title', meta_title('Mutfak Evrakları'))
...
@section('content')
    ...
    <!-- START HAZIRLIK -->
            <div class="card list">
                <div class="card-header">
                    ...
                    <span class="gider-bsl" style="color:#6777ef;"> Mutfak Evrakları </span></h4>
                </div>
     ...
     <div class="card-body">
                    <div class="table-responsive">
                         <table class="table table-striped" id="dataTable">
                            <thead style="font-size:15px;background:#0f90eb;">
								<tr>
                                        ...
                                        <td>@if($expen->image)
                                            <span class="btn btn-outline-secondary badge-pill"> 
                                               <a href="/dekont/{{$expen->image}}" target="_blank">
                                                 <i class="fas fa-utensils text-danger" aria-hidden="true" title="Mutfak" style="font-size:35px;"></i>
                                               </a>
                                             </span>
                                             @else
    ...
    foreach($mutfakRapor as $mutfakRapo){
      ...
      <div class="gider-tablosu col-12">
        <div id="ocak" class=" gider-tablo tabcontent">
            <h1 class="text-dark"> <span  class="text-dark">2023 Yılı <span style="color:#0e8ae2">Mutfak</span> Gider Raporu</span></h1>
            ...
            $("#dataTable").dataTable({
                ...
                initComplete: function () {
                    this.api().columns().every( function () {
                        ...
                        {
                            var select = $('<select class="form-control text-white" style="background:#0c5d97; width:100px;"><option value="">TÜMÜ</option></select>')
