...
@section('title', meta_title('Yakıt Evrakları'))
...
@section('content')
    ...
    <!-- START HAZIRLIK -->
            <div class="card list">
                <div class="card-header">
                    ...
                    <span style="color:#ec550e;">Yakıt Evrakları </span></h4>
                </div>
     ...
     <div class="card-body">
                    <div class="table-responsive">
                         <table class="table table-striped" id="dataTable">
                            <thead style="font-size:15px;background:#ec550e;">
								<tr>
                                        ...
                                        <td>@if($expen->image)
                                            <span class="btn btn-outline-secondary badge-pill"> 
                                               <a href="/dekont/{{$expen->image}}" target="_blank">
                                                 <i class="fa fa-gas-pump text-danger" aria-hidden="true" title="Yakıt" style="font-size:35px;"></i>
                                               </a>
                                             </span>
                                             @else
    ...
    foreach($yakitRapor as $mutfakRapo){
      ...
      <div class="gider-tablosu col-12">
        <div id="ocak" class="gider-tablo tabcontent">
            <h1 class="text-dark"> <span  class="text-dark">2023 Yılı <span style="color:#e3520d;">Yakıt</span> Gider Raporu</span></h1>
            ...
            $("#dataTable").dataTable({
                ...
                initComplete: function () {
                    this.api().columns().every( function () {
                        ...
                        {
                            var select = $('<select class="form-control text-white " style="background:#ad3901;width:100px;"><option value="">TÜMÜ</option></select>')
