        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group payment-types payment-type-1 payment-type-2 payment-type-3 payment-type-4
                    payment-type-5 payment-type-6">
                        <label for="inpPrice">@lang('fields.price')</label>
                        <input type="text" id="inpPrice" class="form-control" readonly>
                    </div>
                    <div class="form-group payment-types  payment-type-7">
                        <label for="inpPrice">@lang('fields.price')</label>
                        <input type="text" name=new_price id="inpPrice2" class="form-control" >
                    </div>
                    <div class="payment-types payment-type-7">
                        <label for="inpPrice">Ödeme Tarihi</label>
                        <input type="datetime-local" id="inDate" name="dateOfPay" class="form-control">
                        <input type="text" id="customer" name="customerID" value="{{ $customer->id }}" class="form-control" style="visibility: hidden;">
                    </div>
                    
                    <div class="payment-types payment-type-7">
                        <label for="inpPrice">Kartın son 4 Hanesi</label>
                        <input type="text" id="cardId" name="cardId" class="form-control" >
                        <input type="text" id="customer2" name="customerID2" value="{{ $customer->id }}" class="form-control" style="visibility: hidden;">
