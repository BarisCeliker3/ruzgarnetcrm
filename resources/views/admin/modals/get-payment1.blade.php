<form method="POST" id="payment1Form">
    <div class="modal fade" tabindex="-1" role="dialog" id="payment1Modal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('titles.get_payment1')</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="inpPrice1" class="form-control" readonly>
                    </div>
                     <div class="form-group">
                        <label for="inpTarih">Tarih</label>
                        <input type="date" id="inpTarih" class="form-control">
                    </div>
...
@push('script')
    ...
    <script>
    inpTarih.max = new Date().toISOString().split("T")[0];</script>
@endpush
