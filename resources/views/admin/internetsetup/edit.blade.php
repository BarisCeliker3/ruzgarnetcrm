    ...
    <!-- START Sözleşmenin Bitmesine 15 Gün Kalan -->
            <div class="card list">
                <div class="card-header">
                    ...
                    <span style="color:#0000b4;">Kurulum Güncelle</span></h4>
           ...
           <hr style="border-bottom:2px solid #FF0000;">  
                ...
                <div class="row">
                     <div class="form-group col-md-6">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Müşteri İsmi</label>
                       <input type="text" name="bbk_code" class="form-control" value="{{ $internetsetup->customer_name}}" disabled>
                   </div>
                    <div class="form-group col-md-6">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Telefon</label>
                       <input type="text" name="telephone" class="form-control" value="{{ $internetsetup->telephone}}" disabled>
                   </div>
                    
                   <div class="form-group col-md-12">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Adres</label>
                      <textarea  name="adress" type="text" class="form-control" disabled> {{ $internetsetup->adress}}</textarea>
                    </div>
                   <div class="form-group col-md-4">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">BBK Kodu</label>
                       <input type="text" name="bbk_code" class="form-control" value="{{ $internetsetup->bbk_code}}" disabled>
                   </div>
                   <div class="form-group col-md-4">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Kullanıcı Adı</label>
                       <input type="text" name="users_name" class="form-control" value="{{ $internetsetup->users_name}}" disabled>
                   </div>
                   <div class="form-group col-md-4">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Şifre</label>
                       <input type="text" name="users_password" class="form-control" value="{{ $internetsetup->users_password}}" disabled>
                   </div>
                  
                </div>
           
                  
             <form method="POST" action="{{ route('admin.internetsetup.postedit',$internetsetup->id) }}" enctype="multipart/form-data">
                @csrf
                   ...
                   <div class="form-group col-md-12">
                    ...
                    <div class="col-lg-6">
                         <div class="form-group">
                            <label for="slcCustomer">Kurulum Durunu</label>
                            <select name="status" id="slcCustomer" class="custom-select selectpicker" required>
                                <option selected disabled>Kurulum Durumu Seç</option>
           ...
           <!-- end task1 status1   --> 
                    <div class="form-group col-md-12">
                      <button style="font-size:19px; float:right"  type="submit" class="btn btn-danger">Tamamla</button>
                    </div>
