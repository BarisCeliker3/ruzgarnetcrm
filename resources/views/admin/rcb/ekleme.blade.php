           ...
           <hr style="border-bottom:2px solid #FF0000;">  
                <div class="col-md-12 form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input value="{{$subsupend->customer->first_name}} {{$subsupend->customer->last_name}}"  type="text" class="form-control" disabled>
                    </div>
                    
                    <div class="form-group col-md-4">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Tarife</label>
                      <input value="{{$subsupend->service->name}}"  type="text" class="form-control" disabled>
                    </div>
                    <div class="form-group col-md-4">
                      <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Telefon</label>
                      <input value="{{  preg_replace('~.*(\d{3})[^\d]{0,7}(\d{3})[^\d]{0,7}(\d{4}).*~', '($1) $2-$3', $subsupend->customer->telephone) }}"  type="text" class="form-control" disabled>
                    </div>
                </div> 
                    
             <form method="POST" action="{{relative_route('admin.rcb.store')}}" class="needs-validation" novalidate>
                 @csrf
                <!-- task1 status1   --> 
             <input value="{{$subsupend->id}}" name="subscription_id" type="hidden" class="form-control" >
             <input value="{{$subsupend->service_id}}" name="service_id" type="hidden" class="form-control" >
             <input value="{{$subsupend->customer_id}}" name="customer_id" type="hidden" class="form-control" >
                  ...
                  <div class="col-md-12 form-row">
                   ...
                   <div class="form-group col-md-6">
                      ...
                      <select name="status"  class="form-control" required>
                          <option value="">Arama Durumu seçin</option>
                   ...
                   <div class="form-group col-md-6">
                      ...
                      <select name="result" class="form-control" required>
                        <option  value="">Müşteri Durumu seçin</option>
                        <option  value="1">Memnun</option>
                        <option  value="0">Memnun Değil</option>
                        <option  value="2">Ulaşılamadı</option>
                      </select>
                   </div>
                  </div><br><br>
           <!-- end task1 status1   --> 
                  ...
                  <button style="float:right; margin-top:-35px"  type="submit" class="btn btn-primary">Kaydet</button>
            </form>
