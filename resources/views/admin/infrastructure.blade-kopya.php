            ...
            <form method="POST" id="infrastructure_statu_form" onsubmit="return processForm()" autocomplete="off">
                <div class="card form">
                    ...
                    <div class="d-flex flex-column my-2 w-100 align-items-center">
                        <table id="table" style="font-size:20px;display:none;" class="table table-bordered">
                            <tr>
                                <th>BBK </th>
                                <td><p id="bbk" style="font-size:20px;">YOK</p></td>
                            </tr>
                            <tr>
                                <th>PORT </th>
                                <td><p id="speed_information" style="font-size:20px;">YOK</p></td>
                            </tr>
                            <tr>
                                <th>ADSL </th>
                                <td><p id="adsl" style="font-size:20px;">YOK</p></td>
                            </tr>
                            <tr>
                                <th>VDSL </th>
                                <td><p id="vdsl" style="font-size:20px;">YOK</p></td>
                            </tr>
                            <tr>
                                <th>FİBER </th>
                                <td><p id="fiber" style="font-size:20px;">YOK</p></td>
                            </tr>
                        </table>
