...
@section('title', meta_title('Stok Müşteri Kaydı Düzenle'))

@section('content')
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{relative_route('admin.stoklistPost',$stok_takip->id)}}">
                @csrf
                <div class="card form">
                    <div class="card-header">
                        <h4>@lang('Stok Müşteri Kaydı Düzenle')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
						 ...
						 <input type="hidden" value="{{ isset(request()->user()->staff) ? request()->user()->staff->id : request()->user()->staff_id }}" name="staff_id" class="form-control">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serino" id="serino" value="{{ $stok_takip->serino }}" class="form-control">
                                </div>
                            </div>
                            <!--Durum-->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="custom-select selectpicker">
                                        <option selected disabled>{{ $stok_takip->status }}</option>
                                        <option @if($stok_takip->status==='Satılık')  selected @endif value="Satılık">Satılık</option>
                                        <option @if($stok_takip->status==='Kiralık') selected @endif value="Kiralık">Kiralık</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="payment" id="payment" class="custom-select selectpicker">
                                        ...
                                        <option @if($stok_takip->payment==='Moka') selected @endif value="Moka">Moka</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" v-model="price" name="price" id="inpPrice"
                                            class="form-control money-input" value="{{ $stok_takip->price }}" min="0" step=".01">
                                    </div>
                                </div>
                            </div>
                            <!--tarih-->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="start_date" id="start_date" value="{{ $stok_takip->start_date }}" class="form-control">
                                </div>
                            </div>
                            <!--adet-->
                            <div class="col-lg-6">
