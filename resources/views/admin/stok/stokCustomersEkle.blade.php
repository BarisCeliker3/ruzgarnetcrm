...
@section('title', meta_title('Stok Müşteri Kaydı'))

@section('content')
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{ relative_route('admin.stokCustomersEkleme') }}">
                <div class="card form">
                    <div class="card-header">
                        <h4>@lang('Stok Müşteri Kaydı')</h4>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" v-model="price" value="0" name="price" id="inpPrice"
                                            class="form-control money-input" min="0" step=".01" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                    <label for="slcbitistarihi">Seri No</label>
