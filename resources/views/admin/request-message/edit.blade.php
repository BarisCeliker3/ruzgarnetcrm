            ...
            <form method="POST" action="{{ relative_route('admin.request.message.edit.put', $requestMessage) }}">
                ...
                <div class="card form">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="talep" name="talep" value="{{$requestMessage->talep}}">
                        <div class="form-group">
                            <label for="slcStatus">Talep Tipi</label>
                            <select disabled name="talep" id="slcStatus2" class="custom-select selectpicker">
                                 <option @if($requestMessage->talep==='İptal') selected @endif value="İptal">İptal</option>
                                 <option @if($requestMessage->talep==='Tarife Değişimi') selected @endif value="Tarife Değişimi">Tarife Değişimi</option>
                                 <option @if($requestMessage->talep==='Diğerleri') selected @endif value="Diğerleri">Diğerleri</option>
                            </select>
                        </div>
