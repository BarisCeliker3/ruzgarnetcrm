        ...
        <div class="col-12">
            <form method="POST" action="{{ relative_route('admin.customer.application.edit', $customer_application) }}">
                <div class="card form">
                    ...
                    <!-- searchStatus start  -->
                        <div class="form-group">
                            <label for="slcStatus">Arama Durumu</label>
                            <select name="searchStatus" id="searchStatus" class="custom-select selectpicker">
                                       <option value="0">Aranmadı</option>
                                       <option value="1">Arandı</option>
                            </select>
                        </div>
                    <!-- searchStatus end  -->
