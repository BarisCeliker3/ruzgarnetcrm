...
@section('title', meta_title('tables.rzgcancel.platinum'))
        ...
        <div class="col-12">
            <div class="card list">
                <div class="card-header">
                    <h4><span class="text-white">İptal / İkna Formu - Platinium</span></h4>
                            ...
                            <tbody>
                                @foreach ($customer_applications as $index => $customer_application)
                                    <tr data-id="{{ $customer_application->id }}">
                                        ...
                                        <td><span title="{{ convert_date($customer_application->created_at, 'large') }}" class="text-dark">{{ $customer_application->created_at }}</span></td>
                                        <td>
                                            <div class="buttons">
            ...
            $("#dataTable").dataTable({
                ...
                initComplete: function () {
                    this.api().columns().every( function () {
                        var column = this;
                        if(column[0][0] != 0 && column[0][0] != 1 && column[0][0] != 2 && column[0][0] != 4 && column[0][0] != 6 && column[0][0] != 7 && column[0][0] != 8)
                        {
