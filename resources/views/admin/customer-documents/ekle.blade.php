...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{ relative_route('admin.customer.document.ekle.post',$customer) }}" enctype="multipart/form-data">
                @csrf
                <div class="card form">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="document_name" id="slcdocument_name" class="custom-select selectpicker">
                                ...
                                <option value="İmza Sirküleri">Kimlik Fotoğrafı</option>
