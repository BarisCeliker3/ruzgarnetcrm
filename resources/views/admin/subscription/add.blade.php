                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="service_id" id="slcService" class="custom-select service-select selectpicker"
                                ...
                                <!-- YENİ TARİFE EKLENDİĞİNDE DEĞİŞECEK  !-->
                                @foreach ($services as $service)
                                   @if($service->id == 72 
                                   || $service->id == 73 
                                   || $service->id == 157 || $service->id == 159 || $service->id == 161 
                                   || $service->id == 162 
                                   || $service->id == 178 || $service->id == 179
                                   || $service->id == 187 || $service->id == 188
                                   
                                   || $service->id == 193 || $service->id == 194 || $service->id == 195
                                   || $service->id == 212 || $service->id == 213
                                   || $service->id == 214 || $service->id == 215
                                   || $service->id == 216 || $service->id == 217
                                   || $service->id == 219 || $service->id == 218
                                   || $service->id == 221 || $service->id == 220 || $service->id == 222
                                   || $service->id == 223 || $service->id == 224
                                   || $service->id == 225 || $service->id == 227
                                   || $service->id == 226
                                   || $service->id == 230 || $service->id == 231
                                   || $service->id == 232 || $service->id == 233)
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4" v-if="hasOption('il_disi')" >
                                <div class="form-group">
                                    <label for="chkIlDisi">İl Dışı Mı?</label>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="chkIlDisi"
                                            name="options[il_disi]" value="1">
                                        <label class="custom-control-label"
                                            for="chkIlDisi">Evet</label>
                                    </div>
                                </div>
                            </div>
                        </div>
