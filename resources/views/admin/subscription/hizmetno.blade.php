...
@section('title', meta_title('Hizmet No'))
...
@section('content')
    <div class="row">
        <div class="col-12"><br><br><br>
            ...
            <form method="POST" action="{{ relative_route('admin.subscription.hizmetnoupdate.put2', $subscription) }}">
                @csrf
           
                <div class="card form">
                    <div class="card-header">
                        <h4>Hizmet Numarası [{{ $subscription->id }}]</h4>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Hizmet Numarası</label>
                                    <input type="text" name="hizmet_no" value="{{ $subscription->hizmet_no }}" id="hizmet_no" class="form-control"
                                        value="">
                                </div>
                            </div>
