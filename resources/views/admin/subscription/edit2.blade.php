...
@section('content')
    <div class="row">
        <div class="col-12"><br><br><br>
            ...
            <form method="POST" action="{{ relative_route('admin.subscription.edit2.put2', $subscription) }}">
                @csrf
           
                <div class="card form">
                    <div class="card-header">
                        <h4>Nakil Ekle / Düzenle [{{ $subscription->id }}]</h4>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Eski Adres</label>
                                    <input type="text" name="nakil_eski_adres" id="nakil_eski_adres" class="form-control"
                                        value="{{ $subscription->nakil_eski_adres }}">
                                </div>
                            </div>
                            
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Yeni Adres</label>
                                    <input type="text" name="nakil_yeni_adres" id="nakil_yeni_adres" class="form-control"
                                        value="{{ $subscription->nakil_yeni_adres }}">
                                </div>
                            </div>
                            
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label style="color:#304FFE; font-weight: bold;font-size:15px;" for="inputEmail4">Taşıma Tarihi</label>
                                    <input type="date" name="nakil_tasima_tarih" id="nakil_tasima_tarih" class="form-control"
                                        value="{{ $subscription->nakil_tasima_tarih }}">
                                </div>
                            </div>
